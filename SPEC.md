...
|---------|----------|--------|
| **0.3** | [spec/0.3.md](spec/0.3.md) | **Current** |
| 0.2     | [spec/0.2.md](spec/0.2.md) | Superseded (validated for back-compat; migrate with `fdf migrate`) |

The `fdf` CLI validates both versions and offers mechanical migration between
adjacent ones. `testdata/` fixtures are the executable conformance contract.
MIT licensed.
